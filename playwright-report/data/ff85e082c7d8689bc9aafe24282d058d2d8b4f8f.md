...
- Name: rental-system.spec.ts >> Customers >> Add New Customer で新規顧客を追加できる
- Location: e2e/rental-system.spec.ts:404:3
...
Locator: getByText('Add New Customer')
Expected: visible
Error: strict mode violation: getByText('Add New Customer') resolved to 2 elements:
    1) <span class="truncate" data-slot="label">Add New Customer</span> aka locator('button').filter({ hasText: 'Add New Customer' })
    2) <h2 data-slot="title" id="reka-dialog-title-v-0-2" class="text-highlighted font-semibold">Add New Customer</h2> aka getByRole('heading', { name: 'Add New Customer' })

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for getByText('Add New Customer')
...
- generic:
  ...
  - generic [ref=e1]:
    ...
    - button [ref=e10] [cursor=pointer]:
      - img [ref=e11]
  - dialog "Add New Customer" [ref=e16]:
    - generic [ref=e17]:
      - generic [ref=e18]:
        - heading "Add New Customer" [level=2] [ref=e19]
        - paragraph [ref=e20]: Register a new customer to the system.
    ...
    - generic [ref=e24]:
      ...
      - generic [ref=e46]:
        - generic [ref=e49]: Passport Image
        - generic [ref=e51]:
          - button "Passport Image" [ref=e53]
          - paragraph [ref=e54]: Upload a clear photo of the passport identification page.
      - generic [ref=e55]:
        - button "Cancel" [ref=e56] [cursor=pointer]:
          - generic [ref=e57]: Cancel
        - button "Register Customer" [ref=e58] [cursor=pointer]:
          - generic [ref=e59]: Register Customer
```

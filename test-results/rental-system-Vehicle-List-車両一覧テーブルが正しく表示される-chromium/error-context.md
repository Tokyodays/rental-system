...
- Name: rental-system.spec.ts >> Vehicle List >> 車両一覧テーブルが正しく表示される
- Location: e2e/rental-system.spec.ts:104:3
...
Locator: getByRole('columnheader', { name: 'Vehicle Name' })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('columnheader', { name: 'Vehicle Name' })
